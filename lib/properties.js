...
export function getInvestPropertiesByCategory(category) {
  return PROPERTIES.filter(
    (property) => property.type === "invest" && property.category === category
  );
}
...
export function getAgriculturePropertiesByCategory(category) {
  return PROPERTIES.filter(
    (property) => property.type === "agriculture" && property.category === category
  );
}
...
export function getIndustrialPropertiesByCategory(category) {
  return PROPERTIES.filter(
    (property) => property.type === "industrial" && property.category === category
  );
}
...
export function getPropertiesByCategory(category) {
  return PROPERTIES.filter(
    (property) => property.type === "commercial" && property.category === category
  );
}
...
export const RENT_BUDGET_RANGES = [
  ...
  { label: "₹1 Lac - ₹3 Lac", min: 100000, max: 300000 },
  { label: "Above ₹3 Lac", min: 300000 },
];
